...
> 📸 **[NHẮC NHỞ CHÈN ẢNH]:** Bạn chụp màn hình danh sách các **IAM Roles** vừa tạo trên giao diện AWS IAM Console, hoặc click vào role `AI-Processing-Role` chụp lại phần Permissions policies để minh họa.
